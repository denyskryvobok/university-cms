...
class TimetableControllerIntegrationTest extends IntegrationTestcontainersInitializer {
    ...
    void getGroupTimetableForOneDay_shouldReturnViewTimetablesForDayWithModelAttributeAndStatus200() throws Exception {
        ...
        List<Timetable> list = List.of(t1, t2, t3, t4, t5);
    ...
    void getTeacherTimetableForMonth_shouldReturnViewTimetablesForMothWithModelAttributeAndStatus200() throws Exception {
        ...
        Map<LocalDate, List<Timetable>> map = Map.of(LocalDate.parse("2022-10-03"), List.of(first, second), LocalDate.parse("2022-10-04"), List.of(third));
    ...
    void getTeacherTimetableForOneDay_shouldReturnViewTimetablesForDayWithModelAttributeAndStatus200() throws Exception {
        Timetable first = new Timetable(1L, 1);
        Timetable second = new Timetable(3L, 2);
        List<Timetable> list = List.of(first, second);
    ...
    void showTimetableManager_shouldReturnStatus200() throws Exception {
        List<Subject> subjects = List.of(new Subject(1L, "Accounting and Finance"), new Subject(2L, "Computer Science"), new Subject(3L, "Architecture"), new Subject(4L, "Chemistry"), new Subject(5L, "English"), new Subject(6L, "Art"), new Subject(7L, "Psychology"), new Subject(8L, "History"), new Subject(9L, "Law"), new Subject(10L, "Economics"));
        List<Teacher> teachers = List.of(new Teacher("Oliver", "Taylor", "367 Pritchard Cour", "Owatonna", "55060", "United States", 1L, "Lecturer in Accounting"), new Teacher("Jack", "Davies", "2830 Elliot Avenue", "Seattle", "98119", "United States", 2L, "Associate Professorship of Computer Science"), new Teacher("Harry", "Evans", "2767 Barrington Court", "Carryville", "72454", "United States", 3L, "Senior Lecturer in Architecture"), new Teacher("Thomas", "Davis", "3952 Shinn Street", "New York", "10004", "United States", 4L, "Chemistry Teacher"), new Teacher("George", "Roberts", "10 Tree Top Lane", "Conshohocken", "19428", "United States", 5L, "Teaching Fellow in English"), new Teacher("Jessica", "Roberts", "2701 Fidler Drive", "San Antonio", "78217", "United States", 6L, "Art & Design Teacher"), new Teacher("Green", "Thomas", "1484 Armbrester Drive", "Irvine", "92614", "United States", 7L, "Lecturer in Psychology"), new Teacher("Sarah", "Hall", "552 Parrish Avenue", "San Antonio", "78205", "United States", 8L, "Lecturer in Roman History"), new Teacher("Charles", "Thomas", "4632 Tanglewood Road", "Tupelo", "38801", "United States", 9L, "Lecturer - Foundation Law"), new Teacher("Karen", "Clarke", "4487 Nickel Road", "Alhambra", "91801", "United States", 10L, "Research Associate in the Economics"));
        ...
        calendarToTimetables.put(new Calendar(1L, LocalDate.parse("2022-10-03")), List.of(t1, t2, t3, t4, t5));
        calendarToTimetables.put(new Calendar(2L, LocalDate.parse("2022-10-04")), List.of(t6, t7, t8, t9, t10, t11));
