...
class CalendarServiceTest extends TestcontainersInitializer{
    ...
    @Test
    void getTimetablesForEachDayOfMonth_shouldReturnMapOfCalendarToListOfTimetable() {
        Map<Calendar, List<Timetable>> actual = calendarService.getTimetablesForEachDayOfMonth(1L, "2022-10");
        Map<Calendar, List<Timetable>> expected = new LinkedHashMap<>();
        ...
        expected.put(c1, List.of(t1, t2, t3, t4, t5));
        ...
        expected.put(c2, List.of(t6, t7, t8, t9, t10, t11));
